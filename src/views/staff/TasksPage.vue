        ...
        <div class="h-100">
            <v-container fluid class="h-100 pa-2">
                <v-row class="ma-0 h-100">
                    <v-col class="vehicles-container pa-0 h-100" :class="{'active': openVehicleSidebar}">
                        <v-row class="ma-0 d-flex" style="max-width: 98%; flex-wrap: nowrap; height: 120px"
                            ...
                            <v-col cols="1" style="max-width: 80px">
                                <v-btn v-model="addCar" fab large color="primary" @click="$router.push('create-new-task')">
                                    <v-icon>
                                        mdi-plus
                                    </v-icon>
                                </v-btn>
                        ...
                        <v-card fluid class="pa-0 mt-0 hey" style="height: calc(100vh - 160px); overflow: hidden ">
                            <v-row class="ma-0 pt-3 pb-3" align="center">
                                ...
                                <v-col class="py-1 text-center d-flex align-center" cols="5"
                                    ...
                                    <div> <span class="mr-10">
                                            Показано заданий: <span>{{ this.countItems }}</span> (Выбрано:
                                    ...
                                    <div>
                                        ...
                                        <v-menu :close-on-content-click="false" max-height="300px" :nudge-width="200"
                                            offset-x>
                                            <template v-slot:activator="{ on, attrs }">
                                                <v-btn :disabled="selected.length == 0" icon v-bind="attrs" v-on="on"
                                                    small>
                                                    <v-tooltip bottom>
                                                        <template v-slot:activator="{ on, attrs }">
                    ...
                    <v-col class="pa-0 h-100 d-none" style="max-width: 400px; height: 90%;"
                        ...
                        <v-card class="pa-0 ml-4" style="height: calc(100vh - 160px); width: 400px; overflow: hidden">
                                    ...
                                    <div class="pa-4">
                                        ...
                                        <div class="d-flex justify-space-between mb-1">
                                            <div class="d-flex align-center">
                                                ...
                                                <div>
                                                    <p style="white-space: nowrap; font-weight: bold" class="mb-0">
        ...
        data() {
            return {
                ...
                tasks: [{
                    id: 1,
                    avatar: 'mdi-account',
                    name: 'Малентина Глызина',
                    title: 'Мерчандайзер Валентина',
                    state: 6,
                    task_name: 'Винотека Альберта Семёнов',
                    ...
                    duration: '-',
                    form: 'Форма',
                    description: 'Описание описаниевжа ывжлм жвжы аоывжа оывждаро ждывао ждвлы раожды   ',
                    creationDate: '12.07.2021',
                    orderNumber: '6',
                    tags: 'Тег 1'
                }, {
