      ...
      <template>
        <div class="date-picker-shortcut-wrapper">
          <div class="date-picker-top">
            ...
            <button class="mx-btn mx-btn-text date-picker-top-last-btn" @click="selectMonthAgo(emit)">
              Прошлый месяц
            </button>
          </div>
        ...
        <div class="d-flex flex-column picker-wrapper">
          ...
          <div class="d-flex">
            <div style="margin-left: auto">
              <v-btn plain type="submit" variant="primary">Выбрать</v-btn>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      onSubmit(evt) {
        this.$root.$emit("show-history", this.dateFilter);
        this.dateTimeSelected = this.dateFilter;
