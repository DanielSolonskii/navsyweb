...
<script>
  import LRoutingMachine from '@/components/MonitoringPage/LRoutingMachine';
  import MapInfoControl from "@/components/MonitoringPage/MapInfoControl";
  import CancelGeoWindow from '@/components/MonitoringPage/CancelGeoWindow';
  import ImportGeoZoneWindow from '@/components/MonitoringPage/ImportGeoZoneWindow';
