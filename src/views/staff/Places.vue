            ...
            <v-card light max-width="500px" height="100%" rounded="0" class="d-flex flex-column pa-4">
                <div>
                    <v-row align="center" class="ma-0">
                        ...
                        <v-col>
                            <span class="text-h5 font-weight-light">Новое место</span>
                        </v-col>
                        <v-col>
                            <v-icon @click="changeProfilePicture()" class="place-profile-panel-picture">
                                {{ editedItem.pic }}</v-icon>
                    ...
                    <v-form ref="form-garage">
                        <v-row class="ma-0 pl-4 pr-2">
                            <v-col cols="10">
                                <v-row>
                                    <v-icon class="mr-3 mt-4">mdi-format-color-text</v-icon>
                                    <v-text-field label="Название" hide-details="auto" v-model="editedItem.name">
                                    </v-text-field>
                                </v-row>
                            </v-col>
                            <v-col cols="10">
                                <v-row>
                                    <v-icon class="mr-3 mt-4">mdi-map-marker</v-icon>
                                    <v-text-field label="Адрес" hide-details="auto" v-model="editedItem.address">
                                    </v-text-field>
                                    <v-icon class="ml-3 mt-4">mdi-map</v-icon>
                                </v-row>
                            </v-col>
                            <v-col cols="10">
                                <v-row>
                                    <v-icon class="mr-3">mdi-text-long</v-icon>
                                    <v-text-field label="Описание" hide-details="auto" v-model="editedItem.description">
                                    </v-text-field>
                                </v-row>
                            </v-col>
                            <v-col cols="10" class="mt-2">
                ...
                <v-col class="vehicles-container pa-0 h-100" :class="{'active': openVehicleSidebar}">
                    <v-row justify="space-between" align="center" class="ma-0">
                        ...
                        <v-col cols="auto" class="px-0">
                            ...
                            <v-text-field v-model="search" ref="search-car" label="Поиск места"
                                placeholder="Поиск места" dense single-line hide-details
                    ...
                    <v-card style="height: calc(100vh - 160px)" class="pa-0">
                        ...
                        <v-card class="height: calc(100vh - 200px);">
                            <v-data-table v-model="selected" @click:row="rowClick" height="calc(100vh - 234px)" dense
                                ...
                                :search="search" hide-default-footer :hide-default-header="hideDefaultHeader"
                                show-select>
                                <template v-if="hideDefaultHeader" v-slot:body.prepend>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <v-text-field v-model="address" type="text" label="Адрес">
                                            </v-text-field>
                                        </td>
                                        <td>
                                            <v-text-field v-model="description" type="text" label="Описание">
                                            </v-text-field>
                                        </td>
                                        <td>
                                            <span>Теги</span>
            ...
            headers() {
                return [{
                    ...
                    },
                    {
                        ...
                        value: "address",
                        filter: f => {
                            return (f + '').toLowerCase().includes(this['address'].toLowerCase())
                        }
                    ...
                    },
                    {
                        ...
                        value: "description",
                        filter: f => {
                            return (f + '').toLowerCase().includes(this['description'].toLowerCase())
                        }
